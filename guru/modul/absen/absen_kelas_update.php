    ...
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
            <?php 
							...
							$queryIzin = oci_parse ($con,"SELECT * FROM tb_siswa 
                    ...
                    <form action="" method="post">
                        ...
                        <table>
                            <?php 
										...
										$siswa = oci_parse ($con,"SELECT * FROM _logabsensi INNER JOIN tb_siswa ON _logabsensi.id_siswa=tb_siswa.id_siswa WHERE  _logabsensi.tgl_absen='$tgl_hari_ini' AND _logabsensi.id_mengajar='$_GET[pelajaran]' ORDER BY _logabsensi.id_siswa ASC  ");
            ...
            <?php 
									if (isset($_POST['update'])) {
										...
										$hari_sekarang= date('Y-m-d');
											...
											$updte_absen = oci_parse ($con,"UPDATE _logabsensi SET ket='$ket' WHERE id_mengajar='$pelajaran' AND id_siswa='$id_siswa' AND tgl_absen='$hari_sekarang' ");
