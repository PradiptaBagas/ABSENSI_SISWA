...
$sql = oci_parse ($con,"SELECT * FROM TB_GURU
WHERE ID_GURU = '$ID_LOGIN'") or die(oci_error($con));
$data = oci_fetch_array($sql);

// tampilkan data mengajar
$MENGAJAR = oci_parse ($con,"SELECT * FROM TB_MENGAJAR 
		...
		<!-- <footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?>(<a href="index.php">)
					</div>				
				</div>
			</footer> -->
		</div>
