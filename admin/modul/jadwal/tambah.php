<?php 
$taAktif = oci_fetch_array(oci_parse ($con,"SELECT * FROM tb_thajaran WHERE status=1 "));
$semAktif = oci_fetch_array(oci_parse ($con,"SELECT * FROM tb_semester WHERE status=1 "));
...
<div class="page-inner">
					...
					<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="guru" class="form-control">
												...
												<?php 
												$guru = oci_parse ($con,"SELECT * FROM tb_guru ORDER BY id_guru ASC");
												foreach ($guru as $g) {
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="mapel" class="form-control">
												<option value="">- Pilih -</option>
												<?php 
												$mapel = oci_parse ($con,"SELECT * FROM tb_master_mapel ORDER BY id_mapel ASC");
												foreach ($mapel as $g) {
						...
						$insert = oci_parse ($con,"INSERT INTO tb_mengajar VALUES (NULL,'$kode','$hari','$waktu','$jamke','$guru','$mapel','$kelas','$semester','$ta' ) ");
