...
<a href="#"><?=strtoupper($d['mapel']) ?></a>
					...
					<div class="row">
						...
						<div class="col-md-12 col-xs-12">
							...
							$queryIzin = oci_parse ($con,"SELECT * FROM tb_izin 
						...
						<label>
								...
								$status = oci_parse ($con,"SELECT * FROM tb_izin
								-- INNER JOIN tb_mengajar ON tb_izin.id_mengajar=tb_mengajar.id_mengajar
									...
									if (isset($_POST['absen'])) {
										...
										for ($i =0; $i <=$total ; $i++) {
											...
											if ($cekAbsesnHariIni > 0) {
												...
												$insert = oci_parse ($con,"INSERT INTO _logabsensi VALUES (NULL,'$pelajaran','$id_siswa','$today','$ket')");
