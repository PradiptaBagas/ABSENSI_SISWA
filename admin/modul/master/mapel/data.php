                ...
                <div class="card-body">
                 ...
                 <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <!-- <?php 
                        $no=1;
			                  $mapel = oci_parse ($con,"SELECT * FROM tb_master_mapel");
                        foreach ($mapel as $k) {?>
                        <tr>
                            <td><?=$no++;?>.</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php 
                if (isset($_POST['edit'])) {
                    $save= oci_parse ($con,"UPDATE tb_master_mapel SET mapel='$_POST[mapel]' WHERE ID_MAPEL='$_POST[id]' ");
                    if ($save) {
                        echo "<script>
                        alert('Data diubah !');
...
<!-- /.modal -->
                    ...
                    <?php
                    $query = "SELECT * FROM TB_MASTER_MAPEL";
        ...
        <div class="modal-content">
           <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <?php 
                if (isset($_POST['save'])) {
                    $save= oci_parse ($con,"INSERT INTO tb_master_mapel VALUES(NULL,'$_POST[kode]','$_POST[mapel]') ");
                    if ($save) {
                        echo "<script>
