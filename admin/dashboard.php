...
<?php
   ...
   // jumlah siswa
$jumlahSiswa = oci_parse($con,"SELECT * FROM TB_SISWA WHERE STATUS=1 ");
oci_execute($jumlahSiswa);
$numrows = oci_fetch_all($jumlahSiswa, $res);

// jumlah guru
$jumlahGuru = oci_parse($con,"SELECT * FROM TB_GURU WHERE STATUS='Y' ");
oci_execute($jumlahGuru);
$numrows2 = oci_fetch_all($jumlahGuru, $res);

$ID_LOGIN = @$_SESSION['admin'];


$sql = oci_parse($con,"SELECT * FROM TB_ADMIN
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">ABSENSI KUY</b>
				</a>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="rekapAbsen">
								<ul class="nav nav-collapse">
									<?php 
									$kelas = oci_parse($con,"SELECT * FROM tb_mkelas ORDER BY id_mkelas ASC");
									foreach ($kelas as $k) {?>
									<li>
							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									...
									if (isset($_POST['changePassword'])) {
										...
										if ($passLama == $pass) {
											$set = oci_parse($con,"UPDATE tb_admin SET password='$newPass' WHERE id_admin='$data[id_admin]' ");
      ...
      <div class="modal-footer">
        ...
        <button name="updateProfile" type="submit" class="btn btn-primary">Simpan</button>
      	...
      	<?php 
					...
					$ganti = oci_parse($con,"UPDATE tb_admin SET foto='$gambar' WHERE id_admin='$_POST[id]' ");
					}  	

					      $sqlEdit = oci_parse($con,"UPDATE tb_admin SET nama_lengkap='$_POST[nama]',username='$_POST[username]' WHERE id_admin='$_POST[id]' ") or die(oci_error($konek));
		...
		<!-- <footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?>(<a href="index.php"> BESKEM </a>)
					</div>				
				</div>
			</footer> -->
		</div>
