        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/guru.png" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">GA BAHAYA TA !!!</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Sigura-gura</a>
                        ...
                        <div class="col-md-4 ml-auto mr-auto col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
									...
									$sqlCek = oci_parse ($con,"SELECT * FROM tb_admin WHERE username='$_POST[username]' AND password='$pass' AND aktif='Y'");
									$jml = oci_num_rows($sqlCek);
									$d = oci_fetch_array($sqlCek);
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y');?> Absensi Siswa.<a href="index.php"></a>
                    </div>
                </div>
            </footer>
