        ...
        <div class="container-login100">
            <div class="wrap-login100">
				...
				if ($_SERVER['REQUEST_METHOD']=='POST') {
					...
					if ($level==1) {
						// Guru
						$sqlCek = oci_parse ($con,"SELECT * FROM TB_GURU WHERE nip='$_POST[username]' AND password='$pass' AND status='Y'");
						...
						// Siswa
								$sqlCek = oci_parse ($con,"SELECT * FROM tb_siswa WHERE nis='$_POST[username]' AND password='$pass' AND status='1'");
								$jml = oci_num_rows($sqlCek);
								$d = oci_fetch_array($sqlCek);
						...
						// Kepsek
								$sqlCek = oci_parse ($con,"SELECT * FROM tb_kepsek WHERE nip='$_POST[username]' AND password='$pass' AND status='Y'");
								$jml = oci_num_rows($sqlCek);
								$d = oci_fetch_array($sqlCek);
